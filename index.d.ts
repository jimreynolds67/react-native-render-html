...
declare module "react-native-render-html" {
    ...
    export interface HTMLProps<P = {}> {
         ...
         */
        remoteLoadingView?: (props: HTMLProps<P>, state: any) => ReactNode;
        /**
         * Replace the default error if a remote website's content could not be fetched.
         */
        remoteErrorView?: (props: HTMLProps<P>, state: any) => ReactNode;
        /**
    ...
    export default class HTML<P> extends Component<HTMLProps<P>> { }
}
